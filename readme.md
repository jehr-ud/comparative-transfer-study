...
This project implements training, evaluation, and Imitation transfer learning using popular RL algorithms (Q-Learning, DQN, PPO, IMPALA) in a custom visual maze environment.
